...
async function testMainBotKazakhSupport() {
  console.log('🚀 Тестируем поддержку казахского языка в основном боте...\n');
  
  try {
    const bot = new TelegramBot(MAIN_BOT_TOKEN, { polling: false });
...
// Запускаем тест
testMainBotKazakhSupport().catch(console.error);
